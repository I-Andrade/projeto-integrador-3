                ...
                <div class="col-md-4">
                    <div class="footer-col">
                        ...
                        <div class='media-body'>
                            Sou designer gráfico, trabalho na área há {{$anos}} anos e amo os desafios que minha profissão me traz.
                        </div>
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="green" href="feer.carrijoo@gmail.com">
                                        feer.carrijoo@gmail.com
                                    </a>
                                </div>
                            </li>
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="green" href="(16)992780943">
                                        (16) 992780943
                                    </a>
                                </div>
                            </li>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">
                        Copyright ©{{date('Y')}} Turma 12 Polo Franca-SP - PI3 Univesp
                    </p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
