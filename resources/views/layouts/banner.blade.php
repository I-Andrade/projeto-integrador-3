        ...
        <div class="swiper-container image-slider-1">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <img class="img-fluid" src="\images\banner_1280x853-elle.jpg">
                </div>
                <!-- end of slide -->
                ...
                <div class="swiper-slide">
                    ...
                    <img class="img-fluid" src="\images\banner_1280x853_lareina.png">
                </div>
                <!-- end of slide -->
                <!-- Slide -->
                <div class="swiper-slide">
                    {{-- <img class="img-fluid" src="https://drive.google.com/uc?export=view&id=1bucAew8L9r8ochVxGTXtFKWby5i5KX8S" alt="alternative"> --}}
                    <img class="img-fluid" src="\images\banner_1280x853_cafeterreiro.png">
                </div>
                <!-- end of slide -->
