            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <form id="contactForm" data-toggle="validator" data-focus="false">
                        ...
                        <div class="row">
                            <div  class="col-lg-6"><input type="tex" class="form-control-input" id="cBigImagem" required="">
                            <label class="label-control" for="cemail">Imagem</label>
                            <div class="help-block with-errors"></div>
                                </div>
                                <div  class="col-lg-6"> <input type="file" class="form-control-input" id="cBigImagem" required=""></div>
